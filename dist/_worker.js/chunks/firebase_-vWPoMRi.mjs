...
ErrorCode$1 = Ab;Bb.COMPLETE="complete";EventType = Bb;mb.EventType=H;H.OPEN="a";H.CLOSE="b";H.ERROR="c";H.MESSAGE="d";E.prototype.listen=E.prototype.K;WebChannel = mb;X.prototype.listenOnce=X.prototype.L;X.prototype.getLastError=X.prototype.Ka;X.prototype.getLastErrorCode=X.prototype.Ba;X.prototype.getStatus=X.prototype.Z;X.prototype.getResponseJson=X.prototype.Oa;X.prototype.getResponseText=X.prototype.oa;
...
class __PRIVATE_FirebaseAppCheckTokenProvider {
    ...
    getToken() {
        ...
        return this.forceRefresh = false, this.appCheck ? this.appCheck.getToken(e).then((e => e ? (__PRIVATE_hardAssert("string" == typeof e.token), 
...
class __PRIVATE_MemoryPersistence {
     ...
     */
    constructor(e, t) {
        this.qr = {}, this.overlays = {}, this.Qr = new __PRIVATE_ListenSequence(0), this.Kr = false, 
        this.Kr = true, this.$r = new __PRIVATE_MemoryGlobalsCache, this.referenceDelegate = e(this), 
 ...
 */
            function __PRIVATE_shouldPersistTargetData(e, t, n) {
                ...
                // closing.
                                if (t.snapshotVersion.toMicroseconds() - e.snapshotVersion.toMicroseconds() >= 3e8) return true;
    ...
    Bo(e, t, n) {
        ...
        // on a closed stream
            ...
            Io: t => {
                ...
                c.open(), l = true), __PRIVATE_logDebug(ge, `RPC '${e}' stream ${r} sending:`, t), 
                c.send(t));
            },
            To: () => c.close()
...
class __PRIVATE_DatastoreImpl extends class Datastore {} {
    constructor(e, t, n, r) {
        ...
        this.serializer = r, this.y_ = false;
    }
    w_() {
...
async function __PRIVATE_enableNetworkInternal(e) {
    if (__PRIVATE_canUseNetwork(e)) for (const t of e.B_) await t(/* enabled= */ true);
}
 ...
 */ async function __PRIVATE_disableNetworkInternal(e) {
    for (const t of e.B_) await t(/* enabled= */ false);
}
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
    ...
    for (const e of t) {
        ...
        if (i) {
            for (const t of i.j_) t.X_(e) && (r = true);
            i.z_ = e;
        }
    }
...
class __PRIVATE_QueryListener {
    constructor(e, t, n) {
         ...
         */
        this.na = false, this.ra = null, this.onlineState = "Unknown" /* OnlineState.Unknown */ , 
        this.options = n || {};
    }
    /**
     ...
     */    X_(e) {
        ...
        let t = false;
        return this.na ? this.ia(e) && (this.ta.next(e), t = true) : this.sa(e, this.onlineState) && (this.oa(e), 
        t = true), this.ra = e, t;
    }
    onError(e) {
        this.ta.error(e);
    ...
    /** Returns whether a snapshot was raised. */    Z_(e) {
        this.onlineState = e;
        let t = false;
        return this.ra && !this.na && this.sa(this.ra, e) && (this.oa(this.ra), t = true), 
        t;
    }
    sa(e, t) {
        ...
        if (e.inorderTraversal(((e, t) => {
            ...
            // Calculate change
                ...
                u.data.isEqual(c.data) ? l !== h && (n.track({
                    ...
                    type: 2 /* ChangeType.Modified */ ,
                    doc: c
                }), P = true, (_ && this.Aa(c, _) > 0 || a && this.Aa(c, a) < 0) && (
 ...
 */ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
    ...
    e.Ka = (t, n, r) => async function __PRIVATE_applyDocChanges(e, t, n, r) {
        ...
        /* usePreviousResults= */ false).then((({documents: e}) => t.view.ma(e, i))));
    ...
    /* usePreviousResults= */ true), o = new __PRIVATE_View(t, s.Ts), _ = o.ma(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" /* OnlineState.Offline */ !== e.onlineState, i), u = o.applyChanges(_, 
 ...
 */ class __PRIVATE_AsyncQueueImpl {
 ...
 // Failure will be handled by AsyncQueue
    ...
    gu(e) {
        const t = this.mu.then((() => (this.du = true, e().catch((e => {
            this.Eu = e, this.du = false;
            const t = 
            /**
 ...
 */ class __PRIVATE_UserDataReader {
    ...
    /** Creates a new top-level parse context. */    Qu(e, t, n, r = false) {
 ...
 */ !function __PRIVATE_registerFirestore(e, t = true) {
    ...
    }), "PUBLIC").setMultipleInstances(true)), registerVersion(w, "4.7.3", e), 
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
...
export { doc as a, getDoc as b, collection as c, db as d, getDocs as g, limit as l, orderBy as o, query as q };
